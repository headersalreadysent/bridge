...
public final class Response implements AsResults, Serializable {
    ...
    protected Response(byte[] data, String url, int code,
                       String message, HashMap<String, List<String>> headers,
                       boolean didRedirect, int redirectCount) throws IOException {
        this.data = data;
        this.url = url;
        this.code = code;
    ...
    @Nullable public List<String> headerList(String name) {
    ...
    @Nullable private byte[] decompressGZIP(byte[] compressed) throws IOException {
