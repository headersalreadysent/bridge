 ...
 */
@SuppressWarnings({"WeakerAccess", "unused"}) public class CancelCriteria {
    ...
    public int commit() {
        synchronized (LOCK) {
            ...
            final Iterator<Map.Entry<String, CallbackStack>> iter = client.requestMap.entrySet().iterator();
            while (iter.hasNext()) {
            ...
            if (client.requestMap.size() == 0)
                client.requestMap = null;
