...
public abstract class RequestConverter<ObjectType, ArrayType> extends Converter {
    ...
    @NotNull public static String getContentType(
    ...
    public final byte[] convertObject(@Nullable Object object, @NotNull RequestBuilder request) {
    ...
    public final byte[] convertList(@Nullable List list, @NotNull RequestBuilder request) {
        if (list == null || list.size() == 0) return null;
        Object[] array = list.toArray();
        return convertArray(array, request);
    }

    public final byte[] convertArray(@Nullable Object[] objects, @NotNull RequestBuilder request) {
    ...
    private ObjectType processObject(@NotNull Object object, @NotNull RequestBuilder request) {
    ...
    private void processArray(@NotNull ObjectType parent,
                              @NotNull Object fieldValue,
                              @NotNull Field field,
                              int fieldType,
                              @NotNull RequestBuilder request) throws Exception {
    ...
    private void processList(@NotNull ObjectType parent,
                             @NotNull Object fieldValue,
                             @NotNull Field field,
                             int fieldType,
                             @NotNull RequestBuilder request) throws Exception {
        ...
        for (final Object fieldArrayValue : list) {
            if (isPrimitive(elementType)) {
                onAttachValueToArray(array, fieldArrayValue, fieldType);
            } else if (isArray(elementType) || isArrayList(elementType)) {
                throw new IllegalStateException("2D arrays/lists are currently not supported for request conversion.");
    ...
    public abstract void onPrepare(@NotNull RequestBuilder request, @NotNull Object object) throws Exception;

    public abstract void onPrepare(@NotNull RequestBuilder request, @NotNull Object[] objects) throws Exception;
    ...
    @NotNull public abstract String getFieldOutputName(@NotNull Field field) throws Exception;

    @NotNull public abstract ObjectType getAttachTarget
            (@NotNull ObjectType parent, @NotNull String[] nameParts);

    public abstract void onAttachValueToObject(
            @NotNull String name, @NotNull ObjectType object, @Nullable Object value, int fieldType) throws Exception;

    public abstract void onAttachValueToArray(
            @NotNull ArrayType array, @Nullable Object value, int fieldType) throws Exception;

    public abstract void onAttachObjectToParent(
            @NotNull String name, @Nullable ObjectType object, @NotNull ObjectType parent) throws Exception;

    public abstract void onAttachArrayToParent(
            @NotNull String name, @Nullable ArrayType array, @NotNull ObjectType parent) throws Exception;

    @Nullable public abstract byte[] onFinish(
            @NotNull ObjectType output, @NotNull RequestBuilder request, @NotNull Object object) throws Exception;

    @Nullable public abstract byte[] onFinish(
            @NotNull ArrayType output, @NotNull RequestBuilder request, @NotNull Object[] objects) throws Exception;
}