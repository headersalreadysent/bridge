...
public final class RequestBuilder implements AsResultsExceptions, Serializable {
    ...
    @Nullable public Response response() throws BridgeException {
        return request().response();
    }

    @Nullable public byte[] asBytes() throws BridgeException {
        throwIfNotSuccess();
    ...
    @Override public void asBytes(final @NotNull ResponseConvertCallback<byte[]> callback) {
    ...
    @Override public void asString(final @NotNull ResponseConvertCallback<String> callback) {
        request(new Callback() {
            @Override
            public void response(@NotNull Request request, Response response, BridgeException e) {
                if (e != null) {
    ...
    @Override public void asFile(
            final @NotNull File destination,
            final @NotNull ResponseConvertCallback<File> callback) {
        request(new Callback() {
            @Override
            public void response(@NotNull Request request, Response response, BridgeException e) {
                if (e != null) {
    ...
    @Override public <T> void asClassArray(
            final @NotNull Class<T> cls,
            final @NotNull ResponseConvertCallback<T[]> callback) {
        request(new Callback() {
            @Override
