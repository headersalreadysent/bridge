...
@SuppressWarnings({"WeakerAccess", "unused"}) public class BridgeException extends Exception {
    ...
    protected BridgeException(@SuppressWarnings("NullableProblems") @NotNull Request request, Exception wrap) {
        super(wrap);
    ...
    protected BridgeException(@SuppressWarnings("NullableProblems") @NotNull Request cancelledRequest) {
    ...
    protected BridgeException(@Nullable Response response, ResponseValidator validator, @NotNull Exception e) {
    ...
    protected BridgeException(@NotNull Response response, @NotNull Exception e, int reason, boolean forceString) {
